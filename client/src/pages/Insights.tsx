      ...
      <nav className="sticky top-0 z-50 bg-white bg-opacity-95 backdrop-blur-sm border-b" style={{ borderColor: "rgba(212, 165, 116, 0.2)" }}>
        <div className="container flex items-center justify-between py-4">
          ...
          <div className="flex gap-8 items-center">
            ...
            <a href="/insights" className="text-[#c85a3a] font-semibold transition-colors">
              Insights
            </a>
          </div>
        </div>
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-[#6b6b6b] leading-relaxed max-w-2xl mx-auto">
              Essays exploring the intersection of AI, human potential, and the transformation of how we live and work. Written by Joseph Pisa, founder of the Time & Attention movement.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-br from-[#c85a3a] to-[#2d5a3d] text-white">
        <div className="container">
          <div className="max-w-4xl mx-auto">
            ...
            <h2 style={{ fontFamily: "'Cormorant Garamond', serif" }} className="text-4xl md:text-5xl font-bold mb-6">
              {insights[0].title}
            </h2>
            ...
            <a href="#insight-0" className="inline-flex items-center gap-2 px-6 py-3 bg-white text-[#c85a3a] rounded-lg font-semibold hover:bg-gray-100 transition-all duration-300 hover:scale-105">
              ...
              <article key={idx} id={`insight-${idx}`} className="scroll-mt-20">
                <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                  <div className="p-8 md:p-12">
                    <div className="mb-6">
                      <h2 style={{ fontFamily: "'Cormorant Garamond', serif" }} className="text-3xl md:text-4xl font-bold text-[#2a2a2a] mb-4">
                        {insight.title}
                      </h2>
                    ...
                    <div className="mt-8 pt-8 border-t border-gray-200">
                      <div className="flex items-center justify-between">
                        <div className="text-sm text-[#6b6b6b]">
                          Written by <span className="font-semibold text-[#2a2a2a]">{insight.author}</span>
                        </div>
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            ...
            <p className="text-lg text-[#6b6b6b] leading-relaxed">
              These essays are just the beginning. The Time & Attention movement is about collective wisdom, shared vision, and building the future together.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="/" className="px-8 py-4 rounded-lg font-semibold transition-all duration-300 hover:scale-105 active:scale-95 bg-[#c85a3a] text-white hover:bg-[#b84a2a]">
                Explore Our Mission
              </a>
              <a href="/future-vision" className="px-8 py-4 rounded-lg font-semibold transition-all duration-300 hover:scale-105 active:scale-95 bg-[#a8d5ba] text-[#2a2a2a] hover:bg-[#98c5aa]">
