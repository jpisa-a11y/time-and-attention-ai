  ...
  const mentors = [
    {
      ...
      philosophy:
        '"Every person deserves a fair shot at homeownership. My job is to make sure the process is transparent and the outcome is fair."',
      color: "text-[#c85a3a]",
    },
    {
      ...
      philosophy:
        '"Real estate is where dreams meet strategy. I help clients make smart decisions that build lasting wealth."',
      color: "text-[#2d5a3d]",
    },
    {
      name: "Priya Patel",
      ...
      credentials:
        "JD, Licensed Real Estate Attorney, Consumer Rights Advocate",
      ...
      philosophy:
        '"Technology should serve people, not exploit them. I ensure that AI decisions are fair, transparent, and legally sound."',
      color: "text-[#a8d5ba]",
    },
    {
      name: "Michael Torres",
      ...
      philosophy:
        "\"Financial freedom isn't just about approval—it's about building a foundation for long-term wellbeing and peace of mind.\"",
      color: "text-[#c85a3a]",
    },
  ];
      ...
      <section className="py-20 md:py-32 bg-gradient-to-b from-[#e8dcc8] to-[#f9f7f4]">
        <div className="container text-center">
          ...
          <p className="text-xl text-[#6b6b6b] max-w-2xl mx-auto leading-relaxed">
            Behind every AI decision is a licensed human professional. Meet the
            experts who ensure fairness, transparency, and genuine care in every
            approval.
          </p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-[#6b6b6b] leading-relaxed text-center mb-12">
              AI is powerful, but it's not perfect. Our licensed mentors provide
              the human judgment, ethical oversight, and personalized guidance
              that technology alone cannot offer. They catch exceptions,
              understand nuance, and ensure every decision serves your best
              interests.
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Licensed professionals ensure AI decisions are fair, transparent, and legally compliant.",
              },
              {
                icon: Heart,
                title: "Human Judgment",
                description:
                  "Nuanced decisions that consider your complete situation, not just data points.",
              },
              {
                icon: Award,
                title: "Expertise",
                description:
                  "Decades of combined experience across mortgage, finance, law, and community support.",
              },
              {
                icon: Briefcase,
                title: "Accountability",
                description:
                  "Licensed professionals who stand behind every decision and are answerable to you.",
              },
            ].map((item, idx) => (
              <div
                key={idx}
                className="rounded-lg bg-[#f9f7f4] p-6 md:p-8 text-center"
        ...
        <div className="container">
          <div className="space-y-20">
            {mentors.map((mentor, idx) => (
              <div
                key={idx}
                className="rounded-lg overflow-hidden bg-white shadow-sm hover:shadow-md transition-all duration-300"
                style={{ border: "1px solid rgba(212, 165, 116, 0.3)" }}
              >
                <div
                  className={`grid md:grid-cols-2 gap-0 ${idx % 2 === 1 ? "md:flex-row-reverse" : ""}`}
                >
                  {/* Image */}
                  <div
                    className={`relative h-96 md:h-full ${idx % 2 === 1 ? "md:order-2" : ""}`}
                  >
                    <img
                      src={mentor.image}
                      alt={mentor.name}
                  ...
                  {/* Content */}
                  <div
                    className={`p-8 md:p-12 flex flex-col justify-center ${idx % 2 === 1 ? "md:order-1" : ""}`}
                  >
                    <div className="mb-6">
                      <h3
                        style={{ fontFamily: "'Cormorant Garamond', serif" }}
                        className="text-3xl md:text-4xl font-bold text-[#2a2a2a] mb-2"
                      >
                        {mentor.name}
                      </h3>
                      <p
                        className={`text-lg font-semibold ${mentor.color} mb-2`}
                      >
                        {mentor.title}
                      </p>
                    ...
                    <div className="mb-6">
                      <h4
                        style={{ fontFamily: "'Cormorant Garamond', serif" }}
                        className="text-lg font-bold text-[#2a2a2a] mb-3"
                      >
                        Areas of Expertise
                      </h4>
                      <ul className="space-y-2">
                        {mentor.expertise.map((exp, expIdx) => (
                          <li key={expIdx} className="flex gap-3">
                            <span
                              className={`text-lg font-bold ${mentor.color} flex-shrink-0`}
                            >
                              ✓
                            </span>
                    ...
                    <div
                      ...
                      style={{
                        backgroundColor: "rgba(200, 90, 58, 0.05)",
                        borderLeft: "4px solid #c85a3a",
                      }}
                    >
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="rounded-lg bg-[#e8dcc8] p-8 md:p-12 mb-12">
              <p className="text-lg text-[#2a2a2a] leading-relaxed mb-6">
                We believe that technology should serve humanity, not the other
                way around. Our mentors bring diverse expertise—mortgage
                banking, financial planning, law, and community support—to
                ensure that every decision is not just smart, but fair and
                human-centered.
              </p>
              <p className="text-lg text-[#2a2a2a] leading-relaxed mb-6">
                We're committed to the "pay it forward" mission. Our mentors
                don't just approve mortgages—they build relationships, provide
                guidance, and connect people with resources. When you succeed,
                we succeed. And when you succeed, you pay it forward.
              </p>
              <p className="text-lg text-[#2a2a2a] leading-relaxed">
                This is what human-centered AI looks like: technology that
                amplifies human wisdom, not replaces it. AI that serves people's
                dreams, not corporate profits.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description:
                    "Our team spans mortgage banking, finance, law, and community support—bringing comprehensive perspective to every decision.",
                },
                {
                  title: "Genuine Care",
                  description:
                    "We're not just processing applications. We're helping people achieve their dreams and build better lives.",
                },
                {
                  title: "Accountability",
                  description:
                    "As licensed professionals, we're answerable to you and to our regulatory bodies. Your trust is our responsibility.",
                },
              ].map((value, idx) => (
                <div
                  key={idx}
        ...
        <div className="container">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-lg text-[#6b6b6b] leading-relaxed mb-8">
              Experience the difference that human expertise combined with AI
              intelligence can make. Our mentors are ready to guide you through
              the process with care, transparency, and genuine commitment to
              your success.
            </p>
