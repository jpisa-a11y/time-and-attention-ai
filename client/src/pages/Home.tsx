          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                <h1
                  style={{ fontFamily: "'Cormorant Garamond', serif" }}
                  className="text-5xl md:text-6xl font-bold text-[#2a2a2a] leading-tight"
                >
                  Your Time is Your{" "}
                  <span className="text-[#c85a3a]">Most Precious Asset</span>
                </h1>
                <p className="text-lg text-[#6b6b6b] leading-relaxed max-w-lg">
                  Imagine a world where AI handles life's complexity—mortgage
                  qualification, debt strategy, document review—so you can
                  reclaim your time and attention. This is Joseph Pisa's vision:
                  technology that liberates humanity, not enslaves it.
                </p>
              </div>
      ...
      <section id="vision" className="my-20 md:my-32 py-20 md:py-32 bg-white">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2
              style={{ fontFamily: "'Cormorant Garamond', serif" }}
              className="text-4xl md:text-5xl font-bold text-[#2a2a2a] mb-6"
            >
              The Problem We're Solving
            </h2>
            <p className="text-lg text-[#6b6b6b] leading-relaxed">
              Modern life is fragmented. Work, finance, family, and self-care
              all compete for your limited time and attention. Traditional
              systems demand your presence at every step—document review,
              qualification checks, exception handling. AI should free us from
              this burden, not add to it.
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Mortgage qualification, debt strategy, and financial planning require hours of manual work and expert review.",
              },
              {
                icon: Users,
                title: "Fragmented Services",
                description:
                  "Multiple systems, multiple logins, multiple touchpoints. No unified approach to your financial life.",
              },
              {
                icon: Globe,
                title: "Misaligned Incentives",
                description:
                  "Traditional finance prioritizes profit over people. Where's the incentive to truly serve your interests?",
              },
            ].map((item, idx) => (
              <div
                key={idx}
                className="rounded-lg bg-white shadow-sm p-6 md:p-8 transition-all duration-300 hover:shadow-md"
                style={{ border: "1px solid rgba(212, 165, 116, 0.3)" }}
              >
                <item.icon className="w-12 h-12 text-[#c85a3a] mb-4" />
                <h3
                  style={{ fontFamily: "'Cormorant Garamond', serif" }}
                  className="text-xl font-bold text-[#2a2a2a] mb-3"
                >
                  {item.title}
                </h3>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-lg text-[#6b6b6b] leading-relaxed">
                  Joseph Pisa founded a revolutionary non-profit business
                  structure that shifts our value system from tangible wealth to{" "}
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={idx} className="flex gap-4">
                    ...
                    <p className="text-[#6b6b6b] leading-relaxed pt-0.5">
                      {point}
                    </p>
                  </div>
                ))}
      ...
      <section id="impact" className="my-20 md:my-32 py-20 md:py-32 bg-white">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-[#6b6b6b] leading-relaxed">
              AI doesn't replace human judgment—it enhances it. Licensed human
              mentors oversee AI decisions, ensuring that technology serves
              humanity's best interests while maintaining the highest standards
              of care and ethics.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              <h3
                style={{ fontFamily: "'Cormorant Garamond', serif" }}
                className="text-xl font-bold text-[#2a2a2a] mb-4 flex items-center gap-2"
              >
              ...
              <ul className="space-y-3 text-[#6b6b6b]">
                ...
                <li className="flex gap-2">
                  <span className="text-[#c85a3a] font-bold">•</span>
                  <span>
                    Borrower qualification based on written guidelines
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="text-[#c85a3a] font-bold">•</span>
            ...
            >
              ...
              <ul className="space-y-3 text-[#6b6b6b]">
                ...
                <li className="flex gap-2">
                  <span className="text-[#a8d5ba] font-bold">•</span>
                  <span>
                    Ethical guardrails ensure fairness and transparency
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="text-[#a8d5ba] font-bold">•</span>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-lg text-[#6b6b6b] leading-relaxed">
                  When AI handles the complexity, something beautiful happens.
                  People have time for what matters: family, creativity, rest,
                  community. The paradox is that this liberation makes us more
                  productive—not in the hustle-culture sense, but in the way
                  that truly matters.
                </p>
              </div>
              <div className="space-y-4">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4
                      style={{ fontFamily: "'Cormorant Garamond', serif" }}
                      className="text-[#2a2a2a] font-semibold mb-1"
                    >
                      More Time with Family
                    </h4>
                    <p className="text-[#6b6b6b]">
                      Hours saved on financial administration become moments
                      with loved ones.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#6b6b6b]">
                      Energy previously spent on stress can now fuel passion
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#6b6b6b]">
                      With time and energy restored, people naturally pay it
                      forward, strengthening communities.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section id="mission" className="my-20 md:my-32 py-20 md:py-32 bg-white">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-[#6b6b6b] leading-relaxed">
              We're building a world where AI serves humanity's highest
              aspirations. Where time and attention are valued above material
              accumulation. Where technology enables a less stressful, more
              balanced life. Where paying it forward becomes the natural
            ...
            {[
              {
                title: "Accessibility",
                description:
                  "Lowest rates in the business. AI-powered mortgage and financial services available to everyone, regardless of background.",
                color: "text-[#c85a3a]",
              },
              {
                title: "Integrity",
                description:
                  "Licensed human mentors ensure ethical AI deployment. Transparency in all decisions. Fairness as a core principle.",
                color: "text-[#a8d5ba]",
              },
              {
                title: "Community",
                description:
                  "Non-profit structure ensures profits fund community initiatives. Pay it forward isn't a slogan—it's our business model.",
                color: "text-[#2d5a3d]",
              },
            ].map((value, idx) => (
              <div
                key={idx}
                className="rounded-lg bg-white shadow-sm p-6 md:p-8 transition-all duration-300 hover:shadow-md text-center"
                style={{ border: "1px solid rgba(212, 165, 116, 0.3)" }}
              >
                <h3
                  style={{ fontFamily: "'Cormorant Garamond', serif" }}
                  className={`text-2xl font-bold mb-4 ${value.color}`}
                >
                  {value.title}
                </h3>
                <p className="text-[#6b6b6b] leading-relaxed">
        ...
        <div className="container">
          <div className="max-w-2xl mx-auto">
            ...
            >
              <h2
                style={{ fontFamily: "'Cormorant Garamond', serif" }}
                className="text-4xl md:text-5xl font-bold text-[#2a2a2a] mb-6 text-center"
              >
                The Beautiful Paradox
              </h2>
              <p className="text-lg text-[#6b6b6b] leading-relaxed mb-6">
                <span className="font-semibold text-[#c85a3a]">
                  "AI makes it possible to live a less stressful life and be
                  just as or more productive while increasing efficiency in all
                  sectors of life, allowing for balance between work and family
                  and self-life in the new world of AI."
                </span>
              </p>
              <p className="text-[#6b6b6b] leading-relaxed mb-6">
                This isn't a contradiction. When AI handles complexity, we
                experience less stress. With less stress, we think more clearly
                and act more intentionally. This intentionality translates to
                genuine productivity—not the frenetic kind, but the kind that
                builds lasting value.
              </p>
              <p className="text-[#6b6b6b] leading-relaxed">
                The result? A life where efficiency serves balance, not the
                other way around. Where technology is a tool for liberation, not
                control. Where paying it forward becomes the natural expression
        ...
        <div className="container">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-lg text-[#6b6b6b] leading-relaxed mb-8">
              Join Joseph Pisa's movement. Experience AI that serves your life,
              not the other way around. Discover how technology can liberate
              your time and attention—and how that liberation can change
              everything.
            </p>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-300 text-sm">
                Building a world where AI serves humanity's highest aspirations.
              </p>
            </div>
            <div>
