  ...
  const steps = [
    {
      ...
      description:
        "Start by uploading your financial documents—mortgage application, pay stubs, bank statements, tax returns. Our secure platform makes it easy with drag-and-drop functionality. No complex portals, no confusion.",
      details: [
      ...
      icon: "📄",
      benefits:
        "No stress, no complexity. Just upload and move on with your day.",
    },
    {
      number: 2,
      ...
      description:
        "Our AI immediately analyzes your documents, extracting key information and running it against our qualification guidelines. The system identifies exceptions and flags items requiring human review.",
      details: [
      ...
      icon: "🧠",
      benefits:
        "What used to take hours now happens in seconds. AI handles the complexity.",
    },
    {
      number: 3,
      ...
      description:
        "A licensed mortgage mentor reviews the AI analysis, particularly any exceptions or edge cases. This human expertise ensures fairness, catches nuances AI might miss, and provides personalized guidance.",
      details: [
    ...
    },
    {
      ...
      description:
        "You receive your approval decision with complete transparency. No surprises, no hidden conditions. If approved, you're one step closer to your new home. If exceptions exist, they're clearly explained with next steps.",
      details: [
    ...
    },
    {
      ...
      description:
        "The final step is a smooth, professional closing process. Your documents are prepared, reviewed, and ready. You sign, and your dream becomes reality. The entire process—from upload to keys in hand—is streamlined.",
      details: [
      ...
      <section className="py-20 md:py-32 bg-gradient-to-b from-[#e8dcc8] to-[#f9f7f4]">
        <div className="container text-center">
          ...
          <p className="text-xl text-[#6b6b6b] max-w-2xl mx-auto leading-relaxed">
            From document upload to closing day, we've simplified the mortgage
            process. See how AI and human expertise work together to get you
                ...
                <div key={idx} className="relative">
                  ...
                  <div
                    ...
                    style={{
                      ...
                      backgroundColor:
                        expandedStep === idx ? "#ffffff" : "#f9f7f4",
                    }}
                  >
                    <div className="p-6 md:p-8 flex gap-6 items-start">
                      ...
                      <div className="flex-shrink-0">
                        <div
                          className="w-16 h-16 rounded-full bg-[#c85a3a] text-white flex items-center justify-center font-bold text-2xl"
                          style={{ fontFamily: "'Cormorant Garamond', serif" }}
                        >
                          {step.number}
                        </div>
                      ...
                      <div className="flex-grow">
                        <div className="flex items-start justify-between mb-2">
                          <div>
                            ...
                            <p className="text-[#a8d5ba] font-semibold text-sm">
                              {step.subtitle}
                            </p>
                          </div>
                          <div className="text-right">
                            <p className="text-[#c85a3a] font-semibold text-sm">
                              ⏱ {step.timeframe}
                            </p>
                          </div>
                        </div>
                      ...
                      <div className="flex-shrink-0">
                        <div
                          className={`w-6 h-6 text-[#c85a3a] transition-transform duration-300 ${expandedStep === idx ? "rotate-180" : ""}`}
                        >
                          ▼
                        </div>
                      </div>
                          ...
                          <div className="space-y-6">
                            <div>
                              <h4
                                ...
                                className="text-xl font-bold text-[#2a2a2a] mb-4"
                              >
                                What Happens
                              </h4>
      ...
      <section className="py-20 md:py-32 bg-white">
        <div className="container">
          <div className="max-w-3xl mx-auto">
            <h2
              style={{ fontFamily: "'Cormorant Garamond', serif" }}
              className="text-4xl md:text-5xl font-bold text-[#2a2a2a] mb-12 text-center"
            >
              ...
              {[
                {
                  ...
                  description:
                    "AI accelerates the process, but human judgment ensures quality. We don't rush decisions—we make them faster.",
                },
                {
                  title: "Transparency at Every Step",
                  description:
                    "You know exactly what's happening, why it's happening, and what comes next. No black boxes, no surprises.",
                },
                {
                  title: "Human-Centered Technology",
                  description:
                    "Technology serves you, not the other way around. Licensed experts oversee every decision to ensure fairness.",
                },
              ].map((principle, idx) => (
                <div
                  key={idx}
                  className="rounded-lg bg-[#f9f7f4] p-6 md:p-8"
        ...
        <div className="container">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-lg text-[#6b6b6b] leading-relaxed mb-8">
              Experience the future of mortgage lending. Fast, transparent, and
              human-centered. Your approval could be just hours away.
            </p>
